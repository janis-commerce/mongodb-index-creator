...
curl -s -X POST -H 'content-type: application/json' -d "
	{
		\"username\": \"Mongodb Index Creator\",
		\"icon_url\":\"https://static.janis.in/microservices-v2-logos/janis.png\",
		\"text\": \":package: Versión $PACKAGE_VERSION publicada. <https://github.com/janis-commerce/mongodb-index-creator/blob/master/CHANGELOG.md|[CHANGELOG]>\"
	}" $SLACK_WEBHOOK
