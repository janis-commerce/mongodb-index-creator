...
module.exports = class IndexHelper {
	...
	minifyIndex({
		...
		return {
			key,
			...typeof unique !== 'undefined' && { unique },
			...typeof expireAfterSeconds !== 'undefined' && { expireAfterSeconds },
			...typeof partialFilterExpression !== 'undefined' && { partialFilterExpression },
			...typeof sparse !== 'undefined' && { sparse }
		};
	}
